...
import { RenderSection27_1 } from "./_civil/section27_1";
  ...
  return (
    <div className="p-4 bg-gray-50 rounded-lg shadow space-y-4">
      <h3 className="text-lg font-semibold">
        Section 27 - Use of Information Civil Systems
      </h3>

      {renderBooleanInput(
        "Section 27.1 In the last seven (7) years have you illegally or without proper authorization accessed or attempted to access any information civil system?",
        data.illegalAccess,
      ...
      {renderBooleanInput(
        "Section 27.2 In the last seven (7) years have you illegally or without authorization, modified, destroyed, manipulated, or denied others access to information residing on an information civil system or attempted any of the above?",
      ...
      {renderBooleanInput(
        "Section 27.3 In the last seven (7) years have you introduced, removed, or used hardware, software, or media in connection with any information civil system without authorization, when specifically prohibited by rules, procedures, guidelines, or regulations or attempted any of the above?",
