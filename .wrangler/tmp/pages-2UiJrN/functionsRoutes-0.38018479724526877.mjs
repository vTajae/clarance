...
import { onRequest as __db__db_tes_ts_onRequest } from "/home/runmy/Desktop/clarance-says/functions/db/_db.tes.ts"
...
export const routes = [
  ...
  {
      routePath: "/db/_db.tes",
      mountPath: "/db",
      method: "",
      middlewares: [],
      modules: [__db__db_tes_ts_onRequest],
    },
  {
      routePath: "/greet",
      mountPath: "/",
